using B1TestTask.Data.Models;
using B1TestTask.Infrastructure.Interfaces;
using Microsoft.Data.SqlClient;
using System.Data;
using System.Globalization;

namespace B1TestTask.Infrastructure.Services.FileImporter.Implementations
{
    internal class FileImporter : IFileImporter
    {
        ...
        public async Task ImportFileAsync(string filePath, string tableName)
        {
            ...
            InitializeBulkCopy(bulkCopy, tableName, (sender, e) =>
            {
        ...
        private void InitializeBulkCopy(SqlBulkCopy bulkCopy, string tableName, SqlRowsCopiedEventHandler eventHandler)
        {
